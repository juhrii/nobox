...
*   **Letak File UI:** 
    *   [`lib/presentation/screens/splash/splash_page.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/screens/splash/splash_page.dart)
    *   [`lib/presentation/screens/auth/login_page.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/screens/auth/login_page.dart)
*   **Letak File Logika/State:** 
    *   [`lib/core/providers/auth_provider.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/core/providers/auth_provider.dart)
    *   [`lib/core/utils/app_validator.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/core/utils/app_validator.dart) (Validasi form email/password)
...
*   **Letak File UI:** 
    *   [`lib/presentation/screens/chat/chat_list_page.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/screens/chat/chat_list_page.dart)
    *   [`lib/presentation/widgets/chat_list_skeleton.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/widgets/chat_list_skeleton.dart) (Tampilan *loading shimmer*)
*   **Letak File Logika/State:**
    *   [`lib/core/providers/chat_provider.dart` (Metode 'Chats` & `fetchMoreChats`)](file:///d:/UBIG/proyek/nobox_chat_basic/lib/core/providers/chat_provider.dart)
*   **Cara Kerja & Penyambungan:**
...
*   **Letak File Logika/Service:**
    *   [`lib/core/services/signalr_service.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/core/services/signalr_service.dart)
    *   [`lib/core/providers/chat_provider.dart` (Metode `updateRoomFromSignalR`)](file:///d:/UBIG/proyek/nobox_chat_basic/lib/core/providers/chat_provider.dart)
*   **Cara Kerja & Penyambungan:**
...
*   **Letak File UI:**
    *   [`lib/presentation/screens/chat/chat_detail_page.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/screens/chat/chat_detail_page.dart)
    *   [`lib/presentation/widgets/message_bubble_widget.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/widgets/message_bubble_widget.dart) (Tampilan balon chat)
*   **Letak File Logika/State:**
    *   [`lib/core/model/message.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/core/model/message.dart) (Status `ack` pemetaan centang)
*   **Cara Kerja & Penyambungan:**
...
*   **Letak File UI:**
    *   [`lib/presentation/widgets/quick_reply_overlay.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/widgets/quick_reply_overlay.dart)
*   **Letak File Logika/State:**
    *   [`lib/presentation/screens/chat/chat_detail_page.dart` (Metode `_fetchQuickReplies`)](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/screens/chat/chat_detail_page.dart)
*   **Cara Kerja & Penyambungan:**
...
*   **Letak File UI:**
    *   [`lib/presentation/widgets/channel_icon.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/widgets/channel_icon.dart)
*   **Letak File Logika/State:**
    *   [`lib/core/services/chat_service.dart` (Metode `getChannels` & `getAccounts`)](file:///d:/UBIG/proyek/nobox_chat_basic/lib/core/services/chat_service.dart)
*   **Cara Kerja & Penyambungan:**
...
*   **Letak File UI:**
    *   [`lib/presentation/screens/chat/file_preview_screen.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/screens/chat/file_preview_screen.dart) (Halaman pratinjau sebelum kirim)
*   **Letak File Logika/State:**
    *   [`lib/core/services/media_service.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/core/services/media_service.dart) (Metode upload file ke server)
*   **Cara Kerja & Penyambungan:**
...
*   **Letak File UI:**
    *   [`lib/presentation/widgets/voice_recording_bottom_sheet.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/widgets/voice_recording_bottom_sheet.dart)
    *   [`lib/presentation/widgets/audio_player_widget.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/widgets/audio_player_widget.dart)
*   **Cara Kerja & Penyambungan:**
...
*   **Letak File UI:**
    *   [`lib/presentation/screens/chat/location_picker_page.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/screens/chat/location_picker_page.dart)
*   **Cara Kerja & Penyambungan:**
...
*   **Letak File UI:**
    *   [`lib/presentation/widgets/searchable_dropdown.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/widgets/searchable_dropdown.dart) (Dropdown dengan fitur cari)
*   **Letak File Logika/State:**
    *   [`lib/core/providers/chat_provider.dart` (Getter `chats`)](file:///d:/UBIG/proyek/nobox_chat_basic/lib/core/providers/chat_provider.dart)
...
*   **Letak File UI:**
    *   [`lib/presentation/screens/chat/archive_list_page.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/screens/chat/archive_list_page.dart)
    *   [`lib/presentation/screens/chat/chat_list_page.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/screens/chat/chat_list_page.dart) (Titik kumpul aksi pengguna)
*   **Letak File Logika/State:**
    *   [`lib/core/providers/chat_provider.dart` (Metode `toggleArchive` & `getArchivedConversations`)](file:///d:/UBIG/proyek/nobox_chat_basic/lib/core/providers/chat_provider.dart)
*   **Cara Kerja & Penyambungan (Detail Lane & Variabel):**
    1.  **Aksi Arsip Masal (Multi-select):** User menahan beberapa chat lalu menekan ikon Archive di App Bar (**Line 124**). Sistem melakukan *looping* variabel `_selectedChats` lalu memanggil `chatProvider.toggleArchive(id)` (**Line 164**).
    2.  **Aksi Arsip Tunggal (Bottom Sheet):** User melakukan *long press* di satu chat, memunculkan Bottom Sheet (**Line 1969**). Saat dikonfirmasi, sistem mengirim variabel `chat.id` dari obrolan tersebut ke fungsi `chatProvider.toggleArchive(chat.id)` (**Line 2010**).
    3.  **Proses di Provider:** Fungsi `toggleArchive` (**Line 940** di `chat_provider.dart`) menerima eksekusi ini. Ia akan:
        *   Melakukan pembaruan UI instan (*Optimistic Update*).
        *   Menyimpan ID chat tersebut ke daftar arsip lokal (`_archivedIds` di Shared Preferences).
        *   Menembak API `_chatService.moveToArchive(chatId)` ke server.
    4.  Di halaman `ArchiveListPage`, obrolan dengan status `isArchived == true` ditampilkan. Opsi Unarchive akan menghapus ID chat dari `_archivedIds` lokal dan memanggil kembali fungsi `toggleArchive` untuk mengembalikannya ke beranda.
...
*   **Letak File UI:**
    *   [`lib/presentation/screens/chat/starred_messages_page.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/screens/chat/starred_messages_page.dart)
*   **Letak File Logika/State:**
    *   [`lib/core/providers/chat_provider.dart` (Metode `toggleStar`)](file:///d:/UBIG/proyek/nobox_chat_basic/lib/core/providers/chat_provcider.dart)
*   **Cara Kerja & Penyambungan:**
...
*   **Letak File UI:**
    *   [`lib/presentation/screens/chat/contact_info_page.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/screens/chat/contact_info_page.dart)
    *   [`lib/presentation/screens/chat/edit_contact_page.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/screens/chat/edit_contact_page.dart)
    *   [`lib/presentation/widgets/add_note_dialog.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/widgets/add_note_dialog.dart)
    *   [`lib/presentation/widgets/tag_selection_dialog.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/presentation/widgets/tag_selection_dialog.dart)
*   **Letak File Logika/State:**
    *   [`lib/core/services/contact_detail_service.dart`](file:///d:/UBIG/proyek/nobox_chat_basic/lib/core/services/contact_detail_service.dart)
*   **Cara Kerja & Penyambungan:**
